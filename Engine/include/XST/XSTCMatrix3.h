#ifndef XST_CMATRIX3_H
#define XST_CMATRIX3_H
...
#define XST_MATH_MTX_MUL(_m128Result, _m128Row, _m128Col, _afRow, _afCol, _iColNum, _afTmpCol) \
	...
	{
		class CMatrix3;
		typedef XST_ALIGN( 64 ) CMatrix3 Mtx3;

		class XST_API XST_ALIGN( 64 ) CMatrix3
		{
			public:
			...
			public:
				...
				xst_fi			CMatrix3(cf32* aR1, cf32* aR2, cf32* aR3, cf32* aR4)
								{
									SetRow( 0, aR1 );
									SetRow( 1, aR2 );
									SetRow( 2, aR3 );
				...
				xst_fi			CMatrix3(const Vec4& vecR1, const Vec4& vecR2, const Vec4& vecR3, const Vec4& vecR4)
								{
									SetRow( 0, vecR1.v );
									SetRow( 1, vecR2.v );
									SetRow( 2, vecR3.v );
				...
				xst_fi			CMatrix3(	cf32& f00, cf32& f01, cf32& f02, cf32& f03, 
				...
				xst_fi			CMatrix3(cf32** afMtx)
								...
								CMatrix3(const CMatrix3& Mat) {}

				virtual			~CMatrix3() {}

				xst_fi	void	Swap(CMatrix3* pMat)
				{
					f32 fTmp;
				...
				{
					assert( uiRowID < 4 && "CMatrix3::GetRow" );
				...
				{
					assert( uiColID < 4 && "CMatrix3::GetRow" );
				...
				void Mul(const CMatrix3& mtxRight);

				void Inverse();

				void Transpose();

				void MulTranspose(const CMatrix3& mtxRight);

				static xst_fi CMatrix3 Inverse(const CMatrix3& mtxMatrix)
				{
					CMatrix3 mtxRet;
				...
				static void Inverse(const CMatrix3& mtxSrc, CMatrix3* pMtxOut);

				static void Mul(const CMatrix3& mtxLeft, const CMatrix3& mtxRight, CMatrix3* pMtxOut);

				static xst_fi CMatrix3 Mul(const CMatrix3& mtxLeft, const CMatrix3& mtxRight)
				{
					CMatrix3 mtxRet;
