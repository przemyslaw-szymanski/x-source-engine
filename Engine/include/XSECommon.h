...
namespace XSE
{
    ...
    typedef xst_vector< Vec2 >      Vec2Vec;
    typedef xst_vector< Vec3 >      Vec3Vec;
    typedef xst_vector< Vec4 >      Vec4Vec;
    typedef xst_vector< CPoint >    PointVec;
    typedef xst_vector< Quat >      QuatVec;
