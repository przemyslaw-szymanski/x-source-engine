...
namespace XST
{
	namespace Math
	{
		void CMatrix4::Rotate(cf32& fAngle, const Vec3& vecAxis)
		{
		...
		void CMatrix4::Mul(const CMatrix4& mtxLeft, const CMatrix4& mtxRight, CMatrix4* pMtxOut)
		{
			f32 fSum;
		...
		void CMatrix4::Mul(const CMatrix4& mtxRight)
		{
		...
		void CMatrix4::MulTranspose(const CMatrix4& mtxRight)
		{
			/*#if defined (XST_SSE2)
		...
		//CMatrix4	CMatrix4::Mul(const CMatrix4& mtxLeft, const CMatrix4& mtxRight)
		//{
		//	CMatrix4 mResult;
		//	//#if defined (XST_SSE2)
		//	//	// Use vW to hold the original row
		...
		void	CMatrix4::Inverse(const CMatrix4& mtx, CMatrix4* pMtxOut)
		{
		...
		void CMatrix4::Inverse()
		{
			...
			#elif defined(_XM_SSE_INTRINSICS_)
				XMASSERT(pDeterminant);
				CMatrix4 MT = XMMatrixTranspose(M);
