...
namespace XSE
{
	...
	void CIndexData::SetTriangle(cul32& ulTriangleId, cu16& usIndex0, cu16& usIndex1, cu16& usIndex2)
	{
		...
		m_Data.Write( usIndex0, CalcOffset( ulStartIndex++, m_usIndexSize ) );
		m_Data.Write( usIndex1, CalcOffset( ulStartIndex++, m_usIndexSize ) );
		m_Data.Write( usIndex2, CalcOffset( ulStartIndex++, m_usIndexSize ) );
	}
	...
	//{
	//	m_Data.Delete();
	//	m_ulTriangleCount = m_ulCurrentTriangleId = 0;
	//}
	...
	//	m_ulCurrentTriangleId = ulTriangleId;
	//	ul32 ulStartIndex = ( m_ulCurrentTriangleId ) * 3;
	//	m_Data.SetElement( ulStartIndex++,	usIndex0 );
	//	m_Data.SetElement( ulStartIndex++,	usIndex1 );
	//	m_Data.SetElement( ulStartIndex,	usIndex2 );
	//	/*m_Data.Write( usIndex0, CalcOffset( ulStartIndex++, m_usIndexSize ) );
	//	m_Data.Write( usIndex1, CalcOffset( ulStartIndex++, m_usIndexSize ) );
	//	m_Data.Write( usIndex2, CalcOffset( ulStartIndex++, m_usIndexSize ) );*/
	//}
	...
	//ul32 CIndexData::_CalcOffset(cul32 &ulIndexId)
	//{
	//	return ulIndexId * m_usIndexSize;
	//}
